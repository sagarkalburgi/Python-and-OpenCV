# Mean shift object tracking using mouse click events
'''
...
Then close the frame/window and the program shall track the object using mean shift method
'''
...
def mean_shit():
    global a,b,c,d
    cap = cv2.VideoCapture('traffic2x.mp4')
    ret,frame = cap.read()
    if NameError == True:
        return
    x,y,w,h = a,b,c-a,d-b
